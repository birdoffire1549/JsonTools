...
public class TestJsonToHtml {
	...
	public static void main(String[] args) {
		String json = 
				...
				"    \"55d4ef740d7c10d6a5e1be9b69fb0e15\"\n" + 
				"  ],\n" + 
